...
import (
	...
	"github.com/oneonestar/presto-operator/pkg/client/clientset/versioned/scheme"
...
type OperatorV1alpha1Interface interface {
	...
	PrestoClustersGetter
}

// OperatorV1alpha1Client is used to interact with features provided by the operator.prestosql.io group.
type OperatorV1alpha1Client struct {
	restClient rest.Interface
}

func (c *OperatorV1alpha1Client) PrestoClusters(namespace string) PrestoClusterInterface {
	return newPrestoClusters(c, namespace)
}
